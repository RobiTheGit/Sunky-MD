Snd_EveningStar_Header:
	smpsHeaderStartSong 3
	smpsHeaderVoice     Snd_EveningStar_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $4A

	smpsHeaderDAC       Snd_EveningStar_DAC
	smpsHeaderFM        Snd_EveningStar_FM1,	$00, $10
	smpsHeaderFM        Snd_EveningStar_FM2,	$00, $12
	smpsHeaderFM        Snd_EveningStar_FM3,	$00, $12
	smpsHeaderFM        Snd_EveningStar_FM4,	$00, $12
	smpsHeaderFM        Snd_EveningStar_FM5,	$00, $1C
	smpsHeaderPSG       Snd_EveningStar_PSG1,	$F4, $03, $00, $00
	smpsHeaderPSG       Snd_EveningStar_PSG2,	$F4, $04, $00, $00
	smpsHeaderPSG       Snd_EveningStar_PSG3,	$23, $01, $00, $00
...
Snd_EveningStar_Jump01:
	smpsCall            Snd_EveningStar_Call0A
	smpsAlterPitch      $FF
	smpsCall            Snd_EveningStar_Call0A
	smpsAlterPitch      $F9
	smpsCall            Snd_EveningStar_Call0A
	...
	smpsCall            Snd_EveningStar_Call0A
	smpsAlterPitch      $08
	smpsCall            Snd_EveningStar_Call0B
	smpsCall            Snd_EveningStar_Call0A
	smpsAlterPitch      $FF
	smpsCall            Snd_EveningStar_Call0A
	smpsAlterPitch      $F9
	...
	smpsAlterPitch      $08
	smpsCall            Snd_EveningStar_Call0B
	smpsJump            Snd_EveningStar_Jump01

Snd_EveningStar_Call0A:
	dc.b	nEb2, $0C, nEb2, nRst, $24, nEb2, $0C, nRst, $08, nEb2, $10
	smpsReturn

Snd_EveningStar_Call0B:
...
Snd_EveningStar_FM2:
	smpsSetvoice        $01
	smpsAlterPitch      $F9
	smpsCall            Snd_EveningStar_Call06
	smpsAlterPitch      $04
	smpsCall            Snd_EveningStar_Call07
	smpsAlterPitch      $FF
	smpsCall            Snd_EveningStar_Call06
	smpsCall            Snd_EveningStar_Call08
	smpsAlterPitch      $04
	smpsSetvoice        $02
	smpsFMAlterVol      $02

Snd_EveningStar_Loop05:
	smpsCall            Snd_EveningStar_Call01
	dc.b	nRst, $60
	smpsLoop            $00, $02, Snd_EveningStar_Loop05
	smpsJump            Snd_EveningStar_Loop05

Snd_EveningStar_Call01:
...
Snd_EveningStar_Loop04:
	...
	smpsPan             panCenter, $00
	dc.b	$04
	smpsCall            Snd_EveningStar_Call09
	smpsCall            Snd_EveningStar_Call06
	smpsCall            Snd_EveningStar_Call07
	smpsCall            Snd_EveningStar_Call06
	smpsCall            Snd_EveningStar_Call08
	smpsLoop            $01, $02, Snd_EveningStar_Loop04
	smpsJump            Snd_EveningStar_Loop04

Snd_EveningStar_Call06:
	dc.b	nD4, $08
	smpsFMAlterVol      $0A
	smpsPan             panLeft, $00
	dc.b	$04
...
Snd_EveningStar_Call08:
	...
	smpsPan             panCenter, $00
	dc.b	$04
	smpsLoop            $00, $08, Snd_EveningStar_Call08
	smpsReturn
...
Snd_EveningStar_FM4:
	smpsSetvoice        $01
	smpsAlterPitch      $FC
	smpsCall            Snd_EveningStar_Call02
	smpsAlterPitch      $FE
	smpsCall            Snd_EveningStar_Call03
	smpsAlterPitch      $FD
	smpsCall            Snd_EveningStar_Call02
	smpsCall            Snd_EveningStar_Call04
	smpsAlterPitch      $09
	smpsFMAlterVol      $FB

Snd_EveningStar_Loop03:
	smpsAlterPitch      $FC
	smpsCall            Snd_EveningStar_Call02
	smpsAlterPitch      $FE
	smpsCall            Snd_EveningStar_Call03
	...
	smpsPan             panCenter, $00
	dc.b	$04
	smpsCall            Snd_EveningStar_Call05
	smpsAlterPitch      $FC
	smpsCall            Snd_EveningStar_Call02
	smpsAlterPitch      $FE
	smpsCall            Snd_EveningStar_Call03
	...
	smpsCall            Snd_EveningStar_Call04
	smpsAlterPitch      $09
	smpsLoop            $01, $02, Snd_EveningStar_Loop03
	smpsJump            Snd_EveningStar_Loop03

Snd_EveningStar_Call05:
	smpsPan             panRight, $00
	smpsFMAlterVol      $08
...
Snd_EveningStar_Call04:
	...
	smpsPan             panCenter, $00
	dc.b	$04
	smpsLoop            $00, $08, Snd_EveningStar_Call04
	smpsReturn
...
Snd_EveningStar_Jump00:
	dc.b	nRst, $04
	smpsCall            Snd_EveningStar_Call01
	dc.b	nRst, $60
	smpsCall            Snd_EveningStar_Call01
	dc.b	nRst, $5C
	smpsJump            Snd_EveningStar_Jump00

; PSG1 Data
Snd_EveningStar_PSG1:
	smpsPSGvoice        sTone_04
	dc.b	nRst, $60, nRst, nRst, nRst, $30, nG3, $0C, nA3, nBb3, $08, nC4
	dc.b	$04, nD4, $08, nEb4, $04

Snd_EveningStar_Jump03:
	...
	smpsJump            Snd_EveningStar_Jump03

; PSG2 Data
Snd_EveningStar_PSG2:
	smpsPSGvoice        sTone_04
	smpsModSet          $04, $01, $01, $03
	dc.b	nRst, $04, nRst, $60, nRst, nRst, nRst, $30, nG3, $0C, nA3, nBb3
	dc.b	$08, nC4, $04, nD4, $08, nEb4, $04

Snd_EveningStar_Jump02:
	dc.b	nF4, $60, smpsNoAttack, $18, nEb4, nD4, nEb4, nD4, $60, smpsNoAttack, $18, nC4
	dc.b	nBb3, nC4, nG3, $60, nFs3, $30, nD3, nG3, $60, nG3, $18, nA3
	dc.b	nBb3, nC4, nF4, $60, smpsNoAttack, $18, nEb4, nD4, nEb4, nD4, $60, smpsNoAttack
	dc.b	$30, nRst, $20, nBb3, $04, nC4, $08, nD4, $04, nG3, $60, nFs3
	dc.b	$30, nD3, nG3, $60, nG3, $18, nA3, nBb3, $0C, nC4, nD4, nEb4
	smpsJump            Snd_EveningStar_Jump02

; PSG3 Data
Snd_EveningStar_PSG3:
	smpsPSGform         $E7

Snd_EveningStar_Loop06:
	smpsPSGvoice        sTone_02
	dc.b	(nMaxPSG2-$23)&$FF, $08, $04
	smpsLoop            $00, $1F, Snd_EveningStar_Loop06
	smpsPSGvoice        sTone_05
	dc.b	$0C

Snd_EveningStar_Loop07:
	smpsCall            Snd_EveningStar_Call0C
	smpsCall            Snd_EveningStar_Call0D
	smpsLoop            $01, $04, Snd_EveningStar_Loop07
	smpsCall            Snd_EveningStar_Call0C
	smpsCall            Snd_EveningStar_Call0D
	smpsCall            Snd_EveningStar_Call0C
	smpsPSGvoice        sTone_02
	...
	smpsCall            Snd_EveningStar_Call0C
	smpsCall            Snd_EveningStar_Call0D
	smpsJump            Snd_EveningStar_Loop07

Snd_EveningStar_Call0C:
	smpsPSGvoice        sTone_02
	dc.b	(nMaxPSG2-$23)&$FF, $08, $04
	smpsLoop            $00, $08, Snd_EveningStar_Call0C
	smpsReturn

Snd_EveningStar_Call0D:
	smpsPSGvoice        sTone_02
	dc.b	(nMaxPSG2-$23)&$FF, $08, $04
	smpsLoop            $00, $07, Snd_EveningStar_Call0D
	smpsPSGvoice        sTone_05
	dc.b	$0C
	smpsReturn
...
Snd_EveningStar_DAC:
	dc.b	nRst, $18, dKick
	smpsLoop            $00, $07, Snd_EveningStar_DAC
	dc.b	dKick, $0C, dSnare, $08, $04, dMidTom, $08, dLowTom, $04, dFloorTom, $08, $04

Snd_EveningStar_Loop00:
	smpsCall            Snd_EveningStar_Call00
	smpsLoop            $00, $08, Snd_EveningStar_Loop00

Snd_EveningStar_Loop01:
	smpsCall            Snd_EveningStar_Call00
	smpsLoop            $00, $03, Snd_EveningStar_Loop01
	dc.b	dKick, $0C, dKick, dSnare, $14, $04, nRst, $18, nRst, $08, dSnare, $04
	dc.b	$08, $04

Snd_EveningStar_Loop02:
	smpsCall            Snd_EveningStar_Call00
	smpsLoop            $00, $04, Snd_EveningStar_Loop02
	smpsJump            Snd_EveningStar_Loop00

Snd_EveningStar_Call00:
	dc.b	dKick, $0C, dKick, dSnare, $24, dKick, $0C, dSnare, $08, dMidTom, $04, dLowTom
	dc.b	$08, dFloorTom, $04
	smpsReturn

Snd_EveningStar_Voices:
;	Voice $00
;	$29
