Snd_SSRacing_Header:
	...
	smpsHeaderVoice     Snd_SSRacing_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $04

	smpsHeaderDAC       Snd_SSRacing_DAC
	smpsHeaderFM        Snd_SSRacing_FM1,	$00, $0C
	smpsHeaderFM        Snd_SSRacing_FM2,	$00, $08
	smpsHeaderFM        Snd_SSRacing_FM3,	$00, $12
	smpsHeaderFM        Snd_SSRacing_FM4,	$00, $1A
	smpsHeaderFM        Snd_SSRacing_FM5,	$00, $26
	smpsHeaderPSG       Snd_SSRacing_PSG1,	$00, $04, $00, $00
	smpsHeaderPSG       Snd_SSRacing_PSG2,	$00, $0B, $00, $00
	smpsHeaderPSG       Snd_SSRacing_PSG3,	$00, $02, $00, $00
...
Snd_SSRacing_Loop00:
	dc.b	dKick, $08, $18, $20
	smpsLoop            $00, $07, Snd_SSRacing_Loop00
...
Snd_SSRacing_Loop01:
	dc.b	dKick, dKick, $10
	smpsLoop            $00, $04, Snd_SSRacing_Loop01
	dc.b	$0C, $04

Snd_SSRacing_Loop02:
	dc.b	$10
	smpsLoop            $00, $07, Snd_SSRacing_Loop02
	smpsLoop            $01, $03, Snd_SSRacing_Loop03
	dc.b	$08, $08

Snd_SSRacing_Loop04:
	dc.b	$10
	smpsLoop            $00, $07, Snd_SSRacing_Loop04
...
Snd_SSRacing_Loop05:
	dc.b	dKick, $60, $18, $08
	smpsLoop            $00, $03, Snd_SSRacing_Loop05
...
Snd_SSRacing_Loop4F:
	...
	smpsLoop            $00, $07, Snd_SSRacing_Loop4F
	dc.b	smpsNoAttack, nEb2, $01, smpsNoAttack, nF2, $07, smpsNoAttack, nAb2, $01, smpsNoAttack, nBb2, $07
	dc.b	smpsNoAttack, nEb2, $01, smpsNoAttack, nBb1, $07, smpsNoAttack, nEb2, $01, smpsNoAttack, nF2, $07
	dc.b	smpsNoAttack, nCs2, $01, smpsNoAttack, nBb1, $07, smpsNoAttack, nEb2, $01, smpsNoAttack, nF2, $07
...
Snd_SSRacing_Loop50:
	dc.b	nBb2, nBb3
	smpsLoop            $00, $3C, Snd_SSRacing_Loop50
	dc.b	nBb2, $40
...
Snd_SSRacing_Loop51:
	dc.b	nF2, nF3
	smpsLoop            $00, $04, Snd_SSRacing_Loop51
	dc.b	nAb2, nAb3, nAb2, nAb3, nG2, nG3, nG2, nG3

Snd_SSRacing_Loop52:
	dc.b	nC3, nC4
	smpsLoop            $00, $04, Snd_SSRacing_Loop52
	smpsLoop            $01, $04, Snd_SSRacing_Loop53

Snd_SSRacing_Loop54:
	dc.b	nC2, nC3
	smpsLoop            $00, $3C, Snd_SSRacing_Loop54
	dc.b	nC2, nRst, $38
...
Snd_SSRacing_Loop55:
	dc.b	nF2, nF3
	smpsLoop            $00, $04, Snd_SSRacing_Loop55
	dc.b	nAb2, nAb3, nAb2, nAb3, nG2, nG3, nG2, nG3

Snd_SSRacing_Loop56:
	dc.b	nC3, nC4
	smpsLoop            $00, $04, Snd_SSRacing_Loop56
	smpsLoop            $01, $04, Snd_SSRacing_Loop57
	smpsAlterVol        $04
	dc.b	nF2, $38
	smpsAlterVol        $FF
	dc.b	nG2, $48
...
Snd_SSRacing_Loop58:
	...
	dc.b	nCs3, $48
	smpsLoop            $00, $03, Snd_SSRacing_Loop58
	dc.b	nA2, $20, nAb2, $18, nFs2, $38, nAb2, $10, nA2, $20, nAb2, $18
	dc.b	nCs3, $28, nRst, $08, nCs4, nC3, nC4
	smpsJump            Snd_SSRacing_Loop53
...
Snd_SSRacing_Loop43:
	dc.b	nG1, $20
	smpsLoop            $00, $0D, Snd_SSRacing_Loop43
	dc.b	$0C
	smpsAlterVol        $09
	dc.b	$04
	smpsSetvoice        $04
...
Snd_SSRacing_Loop44:
	...
	smpsLoop            $00, $08, Snd_SSRacing_Loop44

Snd_SSRacing_Loop45:
	dc.b	nEb5, $02, nRst, nEb5, nRst, nEb5, $08
	smpsLoop            $00, $04, Snd_SSRacing_Loop45

Snd_SSRacing_Loop46:
	dc.b	nCs5, $02, nRst, nCs5, nRst, nCs5, $08
	smpsLoop            $00, $04, Snd_SSRacing_Loop46

Snd_SSRacing_Loop47:
	dc.b	nF5, $02, nRst, nF5, nRst, nF5, $08
	smpsLoop            $00, $08, Snd_SSRacing_Loop47

Snd_SSRacing_Loop48:
	dc.b	nFs5, $02, nRst, nFs5, nRst, nFs5, $08
	smpsLoop            $00, $04, Snd_SSRacing_Loop48

Snd_SSRacing_Loop49:
	dc.b	nAb5, $02, nRst, nAb5, nRst, nAb5, $08
	smpsLoop            $00, $04, Snd_SSRacing_Loop49
	smpsLoop            $01, $02, Snd_SSRacing_Loop44
...
Snd_SSRacing_Loop4A:
	...
	dc.b	$18, nE4, $48
	smpsLoop            $00, $04, Snd_SSRacing_Loop4A
	smpsSetvoice        $01
	smpsPan             panCenter, $00
	smpsAlterVol        $06
...
Snd_SSRacing_Loop4B:
	...
	smpsLoop            $00, $0F, Snd_SSRacing_Loop4B
	dc.b	nC4, nRst, $38
	smpsSetvoice        $07
	smpsPan             panCenter, $00
	smpsAlterVol        $FA
...
Snd_SSRacing_Loop4C:
	dc.b	nC4, $20, nD4, $18, nE4, $28, nC4, $10, nD4, nEb4, $20, nF4
	dc.b	$18, nE4, $48
	smpsLoop            $00, $04, Snd_SSRacing_Loop4C
	dc.b	nRst, $20
	smpsSetvoice        $0A
...
Snd_SSRacing_Loop4D:
	...
	smpsAlterVol        $01
	smpsLoop            $00, $0D, Snd_SSRacing_Loop4D
	dc.b	smpsNoAttack, $08
	smpsModOff

Snd_SSRacing_Loop4E:
	dc.b	nRst, $70
	smpsLoop            $00, $07, Snd_SSRacing_Loop4E
	smpsAlterVol        $F9
	smpsJump            Snd_SSRacing_Jump04
...
Snd_SSRacing_Loop3A:
	...
	smpsLoop            $00, $08, Snd_SSRacing_Loop3A

Snd_SSRacing_Loop3B:
	dc.b	nAb3, $02, nRst, nAb3, nRst, nAb3, $08
	smpsLoop            $00, $04, Snd_SSRacing_Loop3B

Snd_SSRacing_Loop3C:
	dc.b	nFs3, $02, nRst, nFs3, nRst, nFs3, $08
	smpsLoop            $00, $04, Snd_SSRacing_Loop3C

Snd_SSRacing_Loop3D:
	dc.b	nBb3, $02, nRst, nBb3, nRst, nBb3, $08
	smpsLoop            $00, $0C, Snd_SSRacing_Loop3D

Snd_SSRacing_Loop3E:
	dc.b	nC4, $02, nRst, nC4, nRst, nC4, $08
	smpsLoop            $00, $04, Snd_SSRacing_Loop3E
	smpsLoop            $01, $02, Snd_SSRacing_Loop3A
	smpsSetvoice        $08
	smpsPan             panLeft, $00
...
Snd_SSRacing_Loop3F:
	...
	smpsLoop            $00, $04, Snd_SSRacing_Loop3F

Snd_SSRacing_Loop40:
	dc.b	nRst, $40
	smpsLoop            $00, $10, Snd_SSRacing_Loop40
	smpsSetvoice        $08
	smpsPan             panLeft, $00
...
Snd_SSRacing_Loop41:
	dc.b	nG4, $10, $10, nF4, nF4, $08, nE4, $10, $18, $10, $10, nG4
	dc.b	nG4, nF4, nF4, $08, nG4, $38, $10
	smpsLoop            $00, $04, Snd_SSRacing_Loop41
...
Snd_SSRacing_Loop42:
	...
	smpsLoop            $00, $03, Snd_SSRacing_Loop42
	dc.b	$10, $10, nFs4, nFs4, $08, nF4, $10, $18, $10, $10, nAb4, nAb4
	dc.b	nFs4, nFs4, $08, nAb4, $38, nG4, $10
	smpsAlterVol        $03
	smpsJump            Snd_SSRacing_Jump03
...
Snd_SSRacing_Loop21:
	...
	dc.b	$08
	smpsAlterVol        $F0
	smpsLoop            $00, $02, Snd_SSRacing_Loop21
	dc.b	nEb4
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
...
Snd_SSRacing_Loop22:
	...
	smpsAlterVol        $F0
	dc.b	nF4
	smpsLoop            $00, $02, Snd_SSRacing_Loop22
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	nEb4
...
Snd_SSRacing_Loop23:
	...
	smpsAlterVol        $10
	dc.b	$08
	smpsLoop            $00, $02, Snd_SSRacing_Loop23
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop24:
	...
	smpsAlterVol        $F0
	dc.b	$04, nRst, nF4, $08
	smpsLoop            $00, $02, Snd_SSRacing_Loop24
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop25:
	...
	smpsLoop            $00, $02, Snd_SSRacing_Loop25
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop26:
	...
	smpsLoop            $00, $02, Snd_SSRacing_Loop26
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop27:
	...
	smpsAlterVol        $F0
	dc.b	nF4, $04, nRst, nF4, $08
	smpsLoop            $00, $02, Snd_SSRacing_Loop27
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop28:
	...
	smpsAlterVol        $F0
	dc.b	$04, nRst, nF4, $08
	smpsLoop            $00, $02, Snd_SSRacing_Loop28
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop29:
	...
	smpsLoop            $00, $02, Snd_SSRacing_Loop29
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop2A:
	...
	smpsLoop            $00, $02, Snd_SSRacing_Loop2A
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop2B:
	...
	smpsAlterVol        $F0
	dc.b	nF4, $04, nRst, nF4, $08
	smpsLoop            $00, $02, Snd_SSRacing_Loop2B
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop2C:
	...
	smpsAlterVol        $F0
	dc.b	$04, nRst, nF4, $08
	smpsLoop            $00, $02, Snd_SSRacing_Loop2C
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop2D:
	...
	smpsAlterVol        $F0
	dc.b	nEb4, $04, nRst, nEb4, $08
	smpsLoop            $00, $02, Snd_SSRacing_Loop2D
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop2E:
	...
	smpsAlterVol        $F0
	dc.b	nCs4, $04, nRst, nCs4, $08
	smpsLoop            $00, $02, Snd_SSRacing_Loop2E
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop2F:
	...
	smpsAlterVol        $F0
	dc.b	nF4, $04, nRst, nF4, $08
	smpsLoop            $00, $02, Snd_SSRacing_Loop2F
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop30:
	...
	smpsAlterVol        $F0
	dc.b	$04, nRst, nF4, $08
	smpsLoop            $00, $02, Snd_SSRacing_Loop30
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop31:
	...
	smpsAlterVol        $F0
	dc.b	nFs4, $04, nRst, nFs4, $08
	smpsLoop            $00, $02, Snd_SSRacing_Loop31
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop32:
	...
	smpsAlterVol        $F0
	dc.b	nAb4, $04, nRst, nAb4, $08
	smpsLoop            $00, $02, Snd_SSRacing_Loop32
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop33:
	...
	smpsLoop            $00, $04, Snd_SSRacing_Loop33
	smpsSetvoice        $09
	smpsAlterVol        $06

Snd_SSRacing_Loop34:
	dc.b	nC4, $08, nG4, $04, nRst, nG4, $08, nC4, nBb4, nC4, nG4, nC4
	smpsLoop            $00, $02, Snd_SSRacing_Loop34
...
Snd_SSRacing_Loop38:
	dc.b	nEb4, $10, $10, nD4, nD4, $08, nC4, $10, $18, $10, nD4, nEb4
	dc.b	nEb4, nD4, nD4, $08, nE4, $38, $10
	smpsLoop            $00, $04, Snd_SSRacing_Loop38
...
Snd_SSRacing_Loop06:
	...
	dc.b	$08
	smpsAlterVol        $F0
	smpsLoop            $00, $03, Snd_SSRacing_Loop06
	dc.b	$04, nRst
...
Snd_SSRacing_Loop07:
	...
	dc.b	$08
	smpsAlterVol        $F0
	smpsLoop            $00, $03, Snd_SSRacing_Loop07
	dc.b	$04, nRst
...
Snd_SSRacing_Loop08:
	...
	dc.b	$08
	smpsAlterVol        $F0
	smpsLoop            $00, $04, Snd_SSRacing_Loop08
	dc.b	$04, nRst
...
Snd_SSRacing_Loop09:
	...
	dc.b	$08
	smpsAlterVol        $F0
	smpsLoop            $00, $03, Snd_SSRacing_Loop09
...
Snd_SSRacing_Loop0A:
	...
	smpsAlterVol        $10
	dc.b	$08
	smpsLoop            $00, $02, Snd_SSRacing_Loop0A
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop0B:
	...
	smpsAlterVol        $F0
	dc.b	$04, nRst, nBb3, $08
	smpsLoop            $00, $02, Snd_SSRacing_Loop0B
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop0C:
	...
	smpsAlterVol        $F0
	dc.b	$04, nRst, nBb3, $08
	smpsLoop            $00, $02, Snd_SSRacing_Loop0C
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop0D:
	...
	smpsAlterVol        $F0
	dc.b	$04, nRst, nBb3, $08
	smpsLoop            $00, $02, Snd_SSRacing_Loop0D
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop0E:
	...
	smpsAlterVol        $F0
	dc.b	$04, nRst, nBb3, $08
	smpsLoop            $00, $02, Snd_SSRacing_Loop0E
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop0F:
	...
	smpsAlterVol        $F0
	dc.b	$04, nRst, nBb3, $08
	smpsLoop            $00, $02, Snd_SSRacing_Loop0F
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop10:
	...
	smpsAlterVol        $F0
	dc.b	$04, nRst, nBb3, $08
	smpsLoop            $00, $02, Snd_SSRacing_Loop10
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop11:
	...
	smpsLoop            $00, $02, Snd_SSRacing_Loop11
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop12:
	...
	smpsAlterVol        $F0
	dc.b	nBb3, $04, nRst, nBb3, $08
	smpsLoop            $00, $02, Snd_SSRacing_Loop12
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop13:
	...
	smpsAlterVol        $F0
	dc.b	$04, nRst, nBb3, $08
	smpsLoop            $00, $02, Snd_SSRacing_Loop13
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop14:
	...
	smpsAlterVol        $F0
	dc.b	$04, nRst, nBb3, $08
	smpsLoop            $00, $02, Snd_SSRacing_Loop14
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop15:
	...
	smpsAlterVol        $F0
	dc.b	$04, nRst, nBb3, $08
	smpsLoop            $00, $02, Snd_SSRacing_Loop15
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop16:
	...
	smpsAlterVol        $F0
	dc.b	$04, nRst, nBb3, $08
	smpsLoop            $00, $02, Snd_SSRacing_Loop16
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop17:
	...
	smpsAlterVol        $F0
	dc.b	$04, nRst, nBb3, $08
	smpsLoop            $00, $02, Snd_SSRacing_Loop17
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop18:
	...
	smpsAlterVol        $F0
	dc.b	$04, nRst, nBb3, $08
	smpsLoop            $00, $02, Snd_SSRacing_Loop18
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $F0
	dc.b	$08
...
Snd_SSRacing_Loop19:
	...
	smpsAlterVol        $F0
	dc.b	nC4, $04, nRst, nC4, $08
	smpsLoop            $00, $02, Snd_SSRacing_Loop19
	smpsAlterVol        $10
	dc.b	$08
	smpsAlterVol        $00
	dc.b	$08
...
Snd_SSRacing_Loop1F:
	dc.b	nC4, $10, $10, nBb3, nBb3, $08, nA3, $10, $18, $10, $10, nC4
	dc.b	nC4, nBb3, nBb3, $08, nC4, $38, $10
	smpsLoop            $00, $04, Snd_SSRacing_Loop1F
...
Snd_SSRacing_Loop69:
	dc.b	nRst, $58
	smpsLoop            $00, $11, Snd_SSRacing_Loop69
...
Snd_SSRacing_Loop66:
	dc.b	nRst, $7C
	smpsLoop            $00, $0C, Snd_SSRacing_Loop66
...
Snd_SSRacing_Loop67:
	dc.b	nRst, $5D
	smpsLoop            $00, $09, Snd_SSRacing_Loop67
...
Snd_SSRacing_Loop68:
	dc.b	nRst, $49
	smpsLoop            $00, $08, Snd_SSRacing_Loop68
...
Snd_SSRacing_Loop59:
	...
	dc.b	$08
	smpsLoop            $00, $10, Snd_SSRacing_Loop59
	smpsPSGvoice        fTone_02
...
Snd_SSRacing_Loop5A:
	...
	smpsPSGvoice        fTone_02
	dc.b	$04
	smpsLoop            $00, $10, Snd_SSRacing_Loop5A
	smpsPSGvoice        fTone_01
	smpsPSGAlterVol     $FE
	dc.b	$0C
	smpsPSGvoice        fTone_02
...
Snd_SSRacing_Loop5B:
	...
	dc.b	$04
	smpsPSGvoice        fTone_02
	smpsLoop            $00, $1F, Snd_SSRacing_Loop5B
	dc.b	$04
	smpsPSGvoice        fTone_01
	smpsPSGAlterVol     $FE
	dc.b	$0C
...
Snd_SSRacing_Loop5C:
	...
	dc.b	$04
	smpsPSGvoice        fTone_02
	smpsLoop            $00, $1B, Snd_SSRacing_Loop5C
	dc.b	$24
	smpsPSGvoice        fTone_01
	smpsPSGAlterVol     $FE
	dc.b	nAb5, $10, $10
...
Snd_SSRacing_Loop5D:
	...
	smpsPSGvoice        fTone_02
	dc.b	$04
	smpsLoop            $00, $1F, Snd_SSRacing_Loop5D
	smpsPSGvoice        fTone_01
	smpsPSGAlterVol     $FE
	dc.b	$0C
	smpsPSGvoice        fTone_02
...
Snd_SSRacing_Loop5E:
	...
	dc.b	$04
	smpsPSGvoice        fTone_02
	smpsLoop            $00, $1F, Snd_SSRacing_Loop5E
	dc.b	$04
	smpsPSGvoice        fTone_01
	smpsPSGAlterVol     $FE
	dc.b	$0C
...
Snd_SSRacing_Loop5F:
	...
	dc.b	$04
	smpsPSGvoice        fTone_02
	smpsLoop            $00, $1F, Snd_SSRacing_Loop5F
	dc.b	$04
	smpsPSGvoice        fTone_01
	smpsPSGAlterVol     $FE
	dc.b	$0C
...
Snd_SSRacing_Loop60:
	...
	dc.b	$04
	smpsPSGvoice        fTone_02
	smpsLoop            $00, $1B, Snd_SSRacing_Loop60
	dc.b	$04, $04, $04
	smpsPSGvoice        fTone_01
	dc.b	$08
	smpsPSGvoice        fTone_02
...
Snd_SSRacing_Loop61:
	...
	smpsPSGvoice        fTone_02
	dc.b	$04
	smpsLoop            $00, $1F, Snd_SSRacing_Loop61
	smpsPSGvoice        fTone_01
	smpsPSGAlterVol     $FE
	dc.b	$0C
	smpsPSGvoice        fTone_02
...
Snd_SSRacing_Loop62:
	...
	dc.b	$04
	smpsPSGvoice        fTone_02
	smpsLoop            $00, $1F, Snd_SSRacing_Loop62
	dc.b	$04
	smpsPSGvoice        fTone_01
	smpsPSGAlterVol     $FE
	dc.b	$10
...
Snd_SSRacing_Loop63:
	...
	smpsPSGvoice        fTone_01
	smpsPSGAlterVol     $FB
	smpsLoop            $00, $0F, Snd_SSRacing_Loop63
	dc.b	$10
	smpsPSGAlterVol     $FE
	dc.b	$10
	smpsPSGvoice        fTone_02
...
Snd_SSRacing_Loop64:
	...
	dc.b	$08
	smpsPSGvoice        fTone_02
	smpsLoop            $00, $0E, Snd_SSRacing_Loop64
	dc.b	$08
	smpsPSGvoice        fTone_01
	dc.b	$08
	smpsPSGAlterVol     $FE
...
Snd_SSRacing_Loop65:
	...
	dc.b	$04
	smpsPSGvoice        fTone_02
	smpsLoop            $00, $2D, Snd_SSRacing_Loop65
	dc.b	$04
	smpsPSGvoice        fTone_01
	smpsPSGAlterVol     $FE
	dc.b	nAb5, $10, $10
	smpsJump            Snd_SSRacing_Jump05
