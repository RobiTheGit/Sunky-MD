Snd_S3DCredits_Header:
	smpsHeaderStartSong 3
	smpsHeaderVoice     Snd_S3DCredits_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $40

	smpsHeaderDAC       Snd_S3DCredits_DAC
	smpsHeaderFM        Snd_S3DCredits_FM1,	$00, $12
	smpsHeaderFM        Snd_S3DCredits_FM2,	$F4, $19
	smpsHeaderFM        Snd_S3DCredits_FM3,	$F4, $18
	smpsHeaderFM        Snd_S3DCredits_FM4,	$00, $13
	smpsHeaderFM        Snd_S3DCredits_FM5,	$00, $12
	smpsHeaderPSG       Snd_S3DCredits_PSG1,	$DC, $02, $00, $00
	smpsHeaderPSG       Snd_S3DCredits_PSG2,	$DC, $02, $00, $00
	smpsHeaderPSG       Snd_S3DCredits_PSG3,	$23, $02, $00, $00
...
Snd_S3DCredits_Jump05:
	...
	dc.b	nG2, nG2, $06, nG3
	smpsJump            Snd_S3DCredits_Jump05
...
Snd_S3DCredits_Jump04:
	...
	smpsJump            Snd_S3DCredits_Jump04
...
Snd_S3DCredits_Jump03:
	...
	dc.b	$0C
	smpsJump            Snd_S3DCredits_Jump03
...
Snd_S3DCredits_Jump02:
	...
	smpsFMAlterVol      $FE
	smpsPan             panRight, $00
	smpsJump            Snd_S3DCredits_Jump02
...
Snd_S3DCredits_Jump01:
	...
	smpsJump            Snd_S3DCredits_Jump01
...
Snd_S3DCredits_Jump07:
	...
	smpsPSGAlterVol     $FF
	dc.b	nRst, nRst
	smpsJump            Snd_S3DCredits_Jump07
...
Snd_S3DCredits_Jump06:
	...
	smpsJump            Snd_S3DCredits_Jump06

; PSG3 Data
Snd_S3DCredits_PSG3:
	smpsPSGform         $E7

Snd_S3DCredits_Loop00:
	smpsCall            Snd_S3DCredits_Call05
	smpsLoop            $00, $03, Snd_S3DCredits_Loop00
	smpsCall            Snd_S3DCredits_Call06
	smpsCall            Snd_S3DCredits_Call07

Snd_S3DCredits_Loop01:
	smpsCall            Snd_S3DCredits_Call05
	smpsLoop            $00, $03, Snd_S3DCredits_Loop01
	smpsCall            Snd_S3DCredits_Call08
	smpsCall            Snd_S3DCredits_Call09

Snd_S3DCredits_Loop02:
	smpsCall            Snd_S3DCredits_Call05
	smpsLoop            $00, $03, Snd_S3DCredits_Loop02
	smpsCall            Snd_S3DCredits_Call08
	smpsCall            Snd_S3DCredits_Call0A

Snd_S3DCredits_Loop03:
	smpsCall            Snd_S3DCredits_Call05
	smpsLoop            $00, $03, Snd_S3DCredits_Loop03
	smpsCall            Snd_S3DCredits_Call08
	smpsCall            Snd_S3DCredits_Call0B
	smpsJump            Snd_S3DCredits_Loop01

Snd_S3DCredits_Call08:
...
Snd_S3DCredits_DAC:
	dc.b	nRst, $60
	smpsLoop            $00, $07, Snd_S3DCredits_DAC
	dc.b	nRst, $30, dMuffledSnare, $12, $18, $06

Snd_S3DCredits_Jump00:
	smpsCall            Snd_S3DCredits_Call00
	smpsCall            Snd_S3DCredits_Call01
	smpsCall            Snd_S3DCredits_Call00
	smpsCall            Snd_S3DCredits_Call02
	smpsCall            Snd_S3DCredits_Call00
	smpsCall            Snd_S3DCredits_Call01
	smpsCall            Snd_S3DCredits_Call00
	smpsCall            Snd_S3DCredits_Call03
	smpsCall            Snd_S3DCredits_Call00
	smpsCall            Snd_S3DCredits_Call01
	smpsCall            Snd_S3DCredits_Call00
	smpsCall            Snd_S3DCredits_Call04
	smpsJump            Snd_S3DCredits_Jump00

Snd_S3DCredits_Call00:
