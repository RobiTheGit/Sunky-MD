...
; players
LevelSelect_SonicAndMiles:		levselstr "SUNKY          "
LevelSelect_SonicAndTails:		levselstr "SUNKY          "
LevelSelect_SonicAlone:		levselstr "SUNKY ALONE"
LevelSelect_MilesAlone:		levselstr "TLELS ALONE"
LevelSelect_TailsAlone:		levselstr "TLELS ALONE"
