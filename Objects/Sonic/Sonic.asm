...
Sonic_Init:													; Routine 0
		...
		move.w	#$80,Max_speed-Max_speed(a4)
...
loc_10BFC:
;		btst	#0,object_control(a0)				; is Sonic interacting with another object that holds him in p;lace or controls his movement somehow?
...
loc_117FC:
		...
		tst.b	(Super_Sonic_Knux_flag).w
		beq.s	loc_11822
		move.w	#$300,d2								; set higher jump speed if super
...
Sonic_UpVelCap:
		...
		cmpi.w	#-$5,y_vel(a0)							; is Sonic's Y speed faster (less than) than -15.75 (-$FC0)?
		bge.s	locret_118FE								; if not, branch
		move.w	#-$5,y_vel(a0)							; cap upward speed
