...
LevelSelectCheat:				= 0	; if 1, enable level select cheat check
GameDebugCheat:			= 0	; if 1, enable debug mode cheat check
SCEDebug:					= 0	; if 1, enable debug level select
Lagometer:					= 0	; if 1, enable debug lagometer
GameDebug:					= 0	; if 1, enable debug mode for player
